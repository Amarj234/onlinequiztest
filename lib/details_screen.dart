...
class DetailsScreen extends StatefulWidget {
  const DetailsScreen({Key? key,required this.name  , required this.image,required this.price, required this.dis,required this.videoid, required this.cid }) : super(key: key);
final String name;
  final String image;
  final String price;
  final String dis;
...
if(check!=null){
  ...
  Navigator.push(
    context,MaterialPageRoute(builder: (context)=> razorpay(name:widget.name,price:widget.price,cid:widget.cid,check:'1'))
  );
}else{
